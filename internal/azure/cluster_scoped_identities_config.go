	...
	serviceManagedIdentityRoleDefinitionSpecs := []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
		{
			Dev: &ClusterScopedIdentityRoleDefinition{
				...
				ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/c0ff367d-66d8-445e-917c-583feb0ef0d4")),
			},
			Public: &ClusterScopedIdentityRoleDefinition{
				DescriptiveName: "Azure Red Hat OpenShift Hosted Control Planes Service Managed Identity",
				ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/c0ff367d-66d8-445e-917c-583feb0ef0d4")),
		...
		ClusterOperatorIdentifierClusterAPIAzure: {
			ControlPlane: &clusterScopedControlPlaneOperatorIdentityPlaneSpec{
				clusterScopedOperatorIdentityPlaneSpec: clusterScopedOperatorIdentityPlaneSpec{
					MinVersionInclusive: to.Ptr(metadataapi.Must(semver.ParseTolerant("4.19"))),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/88366f10-ed47-4cc0-9fab-c8a06148393e")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Hosted Control Planes Cluster API Provider",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/88366f10-ed47-4cc0-9fab-c8a06148393e")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/fc0c873f-45e9-4d0d-a7d1-585aab30c6ed")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Hosted Control Planes Control Plane Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/fc0c873f-45e9-4d0d-a7d1-585aab30c6ed")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/a1f96423-95ce-4224-ab27-4e3dc72facd4")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Cloud Controller Manager",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/a1f96423-95ce-4224-ab27-4e3dc72facd4")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/0336e1d3-7a87-462b-b6db-342b63f7802c")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Cluster Ingress Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/0336e1d3-7a87-462b-b6db-342b63f7802c")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/5b7237c5-45e1-49d6-bc18-a1f62f400748")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Disk Storage Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/5b7237c5-45e1-49d6-bc18-a1f62f400748")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/0d7aedc0-15fd-4a67-a412-efad370c947e")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift File Storage Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/0d7aedc0-15fd-4a67-a412-efad370c947e")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/8b32b316-c2f5-4ddf-b05b-83dacd2d08b5")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Image Registry Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/8b32b316-c2f5-4ddf-b05b-83dacd2d08b5")),
					...
					RoleDefinitionsConfigSets: []*clusterScopedIdentityRoleDefinitionConfigSetsSpec{
						{
							Dev: &ClusterScopedIdentityRoleDefinition{
								...
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/be7a6435-15ae-4171-8f30-4a343eff9e8f")),
							},
							Public: &ClusterScopedIdentityRoleDefinition{
								DescriptiveName: "Azure Red Hat OpenShift Network Operator",
								ResourceID:      metadataapi.Must(azcorearm.ParseResourceID("/providers/Microsoft.Authorization/roleDefinitions/be7a6435-15ae-4171-8f30-4a343eff9e8f")),
